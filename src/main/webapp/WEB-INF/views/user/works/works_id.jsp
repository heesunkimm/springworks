...
<%@ include file="../index_top.jsp" %>
    ...
    <section id="sec_works" class="content">
        ...
        <div class="right_box">
            <!-- 계정관리 -->
            <div class="content_box" id="id_manage">
                <div class="title_box">
                    <p>계정관리</p>
                </div>
                <div class="btn_box">
            ...
            <div class="popup_box" id="create_id" style="display: none;">
                ...
                <a class="close_btn" href="javascript:;" data-popup="create_id"><img src="../images/main/close.png" alt=""></a>
                    ...
                    <div class="input_box">
                        ...
                        <div class="user_loginfo">
                            <div>
                                ...
                                <label>
                                    <span>패스워드</span>
                                    <input type="password" name="user_passwd" value="" readonly>
                                </label>
                            </div>
                            <button class="create_userId" type="button" onclick="create_userId.ajax">사번생성</button>
                        </div>
                        <ul class="log_noti">
            ...
            <div class="popup_box" style="display: none;">
                ...
                <a class="close_btn" href="javascript:;"><img src="../images/main/close.png" alt=""></a>
